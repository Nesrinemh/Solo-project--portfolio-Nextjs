...
function Skills({ title, tool1, tool2, tool3, svg }) {
  return (
    <div class='col-span-4 sm:col-span-2 lg:col-span-1 relative px-5 pt-10 pb-2 flex flex-col justify-start items-center border-2 border-ecru rounded-xl text-gray-900 dark:text-white'>
      {svg}
